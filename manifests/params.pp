class cubbystack::params {
  ...
  case $::osfamily {
    'Debian': {
      ...
      $designate_producer_package_name     = 'designate-producer'
      $designate_producer_service_name     = 'designate-producer'
      ...
      $designate_worker_package_name       = 'designate-worker'
      $designate_worker_service_name       = 'designate-worker'
